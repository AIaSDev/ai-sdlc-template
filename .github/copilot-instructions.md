...
This repository follows the AI-SDLC. Before proposing or changing code:

1. Read `AGENTS.md`.
2. Read `docs/TASKS.md` to identify the current phase and use case.
3. Read `docs/PROJECT.md` for project-specific architecture and commands.
4. Read the active specification in `docs/specs/`, or the Fast Track task entry
   permitted by `AGENTS.md` when no specification applies.
